        ...
        with torch.no_grad():
            ...
            def augmented_dynamics(t, y_aug):
                ...
                with torch.enable_grad():
                    ...
                    # print(adjoint_params,'$'*100)
                    # _params = tuple(torch.as_strided(param, (), ()) for param in adjoint_params)  # noqa # this sentence should be removed if the integrand function is like UMNN
